          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-6 group">
              {i18n.language.startsWith('ar') ? (
                <span dir="rtl" className="text-3xl font-arabic font-extrabold tracking-wide leading-normal flex items-center select-none uppercase gap-1.5 overflow-visible drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">
                  <span className="text-white">اونكس</span>
                  <span className="inline-block px-2.5 py-1.5 pb-2.5 text-transparent bg-clip-text bg-gradient-to-r from-[#C5A05B] to-[#EAD8B1] overflow-visible">
                    فاي
                  </span>
                </span>
              ) : (
            ...
            <div className="flex space-x-4">
              ...
              <button 
                onClick={(e) => {
                  e.preventDefault();
                  window.dispatchEvent(new CustomEvent('open-whatsapp-prompt'));
                }}
                className="p-3 rounded-full border border-brand-cream/10 hover:border-[#25D366] hover:text-[#25D366] transition-all cursor-pointer" 
                title="WhatsApp"
              >
