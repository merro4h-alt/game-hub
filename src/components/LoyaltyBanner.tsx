        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 z-10">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div>
              ...
              <h3 className="text-3xl sm:text-4xl font-black tracking-tighter leading-tight text-white max-w-xl">
                {isArabic ? (
          ...
          <div className="flex flex-col items-center gap-6 w-full lg:w-auto">
            <div className="flex items-center gap-6">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40 max-w-[180px] text-center md:text-start leading-relaxed">
                {isArabic 
                  ? 'العرض يطبق تلقائياً لجميع المشتركين' 
                  : 'Applied automatically for all subscribers'}
              </p>
            </div>
          </div>
        </div>
