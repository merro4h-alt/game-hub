...
const resources = {
  en: {
    translation: {
      ...
      "about": {
        ...
        "heroDesc": "ONXIFI | Where timeless elegance meets modern innovation. Explore a curated selection of premium lifestyle products designed for those who settle for nothing less than extraordinary.",
  ...
  ar: {
    translation: {
      ...
      "reviews": {
        "title": "آراء العملاء",
        "subtitle": "ماذا يقول مجتمعنا عن اونكس فاي",
        "items": {
          "1": {
            "name": "سارة ج.",
      ...
      "about": {
        ...
        "heroTitle2": "والنزاهة",
        "heroDesc": "اونكس فاي | حيث تلتقي الأناقة الخالدة بالابتكار الحديث. اكتشف تشكيلة مختارة من منتجات أسلوب الحياة الفاخرة، المصممة خصيصاً لمن لا يرضون بغير الاستثنائي.",
      ...
      "dropshipping": {
        ...
        "success": {
          ...
          "desc1": "نشكرك على اهتمامك بـ اونكس فاي. يقوم فريقنا حالياً بمراجعة معلوماتك للتأكد من مطابقتها لمعايير الشراكة لدينا.",
